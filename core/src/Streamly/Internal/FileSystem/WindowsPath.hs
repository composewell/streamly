...
--
-- All of these validations are enforced by the Windows API and therefore are
...
-- | Like 'validatePath' but more strict, see isValidPath' for differences.
validatePath' ::
    MonadThrow m => Array OS_WORD_TYPE -> m ()
validatePath' = Common.validatePath' Common.Windows

-- | Like 'isValidPath' but more strict. The path must refer to a file system
...
--
-- >>> arr :: Array Word16 = Path.arrayFromString "hello"
