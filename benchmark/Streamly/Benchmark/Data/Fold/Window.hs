...
{-# INLINE source #-}
source ::
  (Monad m, Stream.IsStream t, Num a, Stream.Enumerable a) =>
  Int ->
  a ->
  t m a
source len from =
  ...
  defaultMain
    [ bgroup
        ...
        [ benchWithFold
          ...
          benchWithFold
            numElements
            "maximum (window size 100)"
            (Window.maximum 100),
          benchWithFold
            numElements
            "maximum (window size 1000)"
            (Window.maximum 1000),
          benchWith
            sourceDescendingInt
            numElements
          ...
          benchWithFold
            numElements
            "range (window size 100)"
            (Window.range 100),
          benchWithFold
            numElements
            "range (window size 1000)"
            (Window.range 1000),
          benchWith
            sourceDescendingInt
            numElements
          ...
          benchWithFoldInt
            numElements
            "sumInt (window size 100)"
            (Ring.slidingWindow 100 Window.sumInt),
          benchWithFoldInt
            numElements
            "sum for Int (window size 100)"
          ...
          benchWithFold
            numElements
            "mean (window size 100)"
            (Ring.slidingWindow 100 Window.mean),
          benchWithFold
            numElements
            "mean (window size 1000)"
          ...
          benchWithFold
            numElements
            "powerSum 2 (window size 100)"
            (Ring.slidingWindow 100 (Window.powerSum 2)),
          benchWithFold
            numElements
            "powerSum 2 (entire stream)"
      ...
      bgroup
        ...
        [ benchWithPostscan
          ...
          benchWithPostscan
            numElements
            "range (window size 10)"
            (Window.range 10),
          benchWithPostscan
            numElements
            "range (window size 30)"
            (Window.range 30),
          benchWithPostscan
            numElements
            "range (window size 1000)"
