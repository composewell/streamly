...
{-# ANN scanl'_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl'_x1 `hasNoType` ''Stream.Step
#endif

{-# ANN scanl'_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl'_x4 `hasNoType` ''Stream.Step
#endif
...
{-# ANN scanlM'_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanlM'_x1 `hasNoType` ''Stream.Step
#endif

{-# ANN scanlM'_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanlM'_x4 `hasNoType` ''Stream.Step
#endif
...
{-# ANN scanl1'_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl1'_x1 `hasNoType` ''Stream.Step
#endif

{-# ANN scanl1'_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl1'_x4 `hasNoType` ''Stream.Step
#endif
...
{-# ANN scanl1M'_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl1M'_x1 `hasNoType` ''Stream.Step
#endif

{-# ANN scanl1M'_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl1M'_x4 `hasNoType` ''Stream.Step
#endif
...
{-# ANN scanl_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'scanl_x4 `hasNoType` ''Stream.Step
...
{-# ANN postscanl_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'postscanl_x4 `hasNoType` ''Stream.Step
...
{-# ANN postscanl'_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'postscanl'_x1 `hasNoType` ''Stream.Step
#endif
...
-- inspect $ 'postscanl'_x4 `hasNoType` ''Stream.Step
#endif
...
{-# ANN postscanlM'_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'postscanlM'_x1 `hasNoType` ''Stream.Step
#endif

{-# ANN postscanlM'_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'postscanlM'_x4 `hasNoType` ''Stream.Step
#endif
...
{-# ANN sequence_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'sequence_x1 `hasNoType` ''Stream.Step
...
{-# ANN tap_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'tap_x1 `hasNoType` ''Stream.Step
...
{-# ANN trace_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'trace_x4 `hasNoType` ''Stream.Step
...
{-# ANN filter_Even_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filter_Even_x1 `hasNoType` ''Stream.Step
inspect $ 'filter_Even_x1 `hasNoType` ''FL.Step
inspect $ 'filter_Even_x1 `hasNoType` ''SPEC
#endif

{-# ANN filter_Even_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filter_Even_x4 `hasNoType` ''Stream.Step
...
{-# ANN filter_AllOut_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filter_AllOut_x1 `hasNoType` ''Stream.Step
inspect $ 'filter_AllOut_x1 `hasNoType` ''FL.Step
inspect $ 'filter_AllOut_x1 `hasNoType` ''SPEC
#endif

{-# ANN filter_AllOut_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filter_AllOut_x4 `hasNoType` ''Stream.Step
...
{-# ANN filter_AllIn_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filter_AllIn_x1 `hasNoType` ''Stream.Step
inspect $ 'filter_AllIn_x1 `hasNoType` ''FL.Step
inspect $ 'filter_AllIn_x1 `hasNoType` ''SPEC
#endif

{-# ANN filter_AllIn_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filter_AllIn_x4 `hasNoType` ''Stream.Step
...
{-# ANN filterM_Even_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filterM_Even_x1 `hasNoType` ''Stream.Step
inspect $ 'filterM_Even_x1 `hasNoType` ''FL.Step
inspect $ 'filterM_Even_x1 `hasNoType` ''SPEC
#endif

{-# ANN filterM_Even_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filterM_Even_x4 `hasNoType` ''Stream.Step
...
{-# ANN filterM_AllOut_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filterM_AllOut_x1 `hasNoType` ''Stream.Step
inspect $ 'filterM_AllOut_x1 `hasNoType` ''FL.Step
inspect $ 'filterM_AllOut_x1 `hasNoType` ''SPEC
#endif

{-# ANN filterM_AllOut_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filterM_AllOut_x4 `hasNoType` ''Stream.Step
...
{-# ANN filterM_AllIn_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filterM_AllIn_x1 `hasNoType` ''Stream.Step
inspect $ 'filterM_AllIn_x1 `hasNoType` ''FL.Step
inspect $ 'filterM_AllIn_x1 `hasNoType` ''SPEC
#endif

{-# ANN filterM_AllIn_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'filterM_AllIn_x4 `hasNoType` ''Stream.Step
...
{-# ANN drop_One_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'drop_One_x1 `hasNoType` ''Stream.Step
inspect $ 'drop_One_x1 `hasNoType` ''FL.Step
inspect $ 'drop_One_x1 `hasNoType` ''SPEC
#endif

{-# ANN drop_One_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'drop_One_x4 `hasNoType` ''Stream.Step
...
{-# ANN drop_All_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'drop_All_x1 `hasNoType` ''Stream.Step
inspect $ 'drop_All_x1 `hasNoType` ''FL.Step
inspect $ 'drop_All_x1 `hasNoType` ''SPEC
#endif

{-# ANN drop_All_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'drop_All_x4 `hasNoType` ''Stream.Step
...
{-# ANN dropWhile_True_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'dropWhile_True_x1 `hasNoType` ''Stream.Step
...
{-# ANN dropWhile_True_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'dropWhile_True_x4 `hasNoType` ''Stream.Step
...
{-# ANN dropWhileM_True_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'dropWhileM_True_x4 `hasNoType` ''Stream.Step
...
{-# ANN dropWhile_False_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'dropWhile_False_x1 `hasNoType` ''Stream.Step
...
{-# ANN dropWhile_False_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'dropWhile_False_x4 `hasNoType` ''Stream.Step
...
{-# ANN findIndices_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'findIndices_x1 `hasNoType` ''Stream.Step
inspect $ 'findIndices_x1 `hasNoType` ''FL.Step
inspect $ 'findIndices_x1 `hasNoType` ''SPEC
#endif

{-# ANN findIndices_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'findIndices_x4 `hasNoType` ''Stream.Step
...
{-# ANN elemIndices_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'elemIndices_x1 `hasNoType` ''Stream.Step
inspect $ 'elemIndices_x1 `hasNoType` ''FL.Step
inspect $ 'elemIndices_x1 `hasNoType` ''SPEC
#endif

{-# ANN elemIndices_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'elemIndices_x4 `hasNoType` ''Stream.Step
inspect $ 'elemIndices_x4 `hasNoType` ''FL.Step
inspect $ 'elemIndices_x4 `hasNoType` ''SPEC
#endif

{-# ANN findIndices_SingleIndex (PermitPatternMatches [''Int]) #-}
...
inspect $ 'findIndices_SingleIndex `hasNoType` ''Stream.Step
inspect $ 'findIndices_SingleIndex `hasNoType` ''FL.Step
inspect $ 'findIndices_SingleIndex `hasNoType` ''SPEC
#endif

{-# ANN elemIndices_SingleIndex (PermitPatternMatches [''Int]) #-}
...
inspect $ 'elemIndices_SingleIndex `hasNoType` ''Stream.Step
...
{-# ANN deleteBy_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'deleteBy_x1 `hasNoType` ''Stream.Step
inspect $ 'deleteBy_x1 `hasNoType` ''FL.Step
inspect $ 'deleteBy_x1 `hasNoType` ''SPEC
#endif

{-# ANN deleteBy_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'deleteBy_x4 `hasNoType` ''Stream.Step
...
{-# ANN uniq_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'uniq_x1 `hasNoType` ''Stream.Step
inspect $ 'uniq_x1 `hasNoType` ''FL.Step
inspect $ 'uniq_x1 `hasNoType` ''SPEC
#endif

{-# ANN uniq_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'uniq_x4 `hasNoType` ''Stream.Step
...
{-# ANN mapMaybe_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'mapMaybe_x1 `hasNoType` ''Stream.Step
inspect $ 'mapMaybe_x1 `hasNoType` ''FL.Step
inspect $ 'mapMaybe_x1 `hasNoType` ''SPEC
#endif

{-# ANN mapMaybe_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'mapMaybe_x4 `hasNoType` ''Stream.Step
...
{-# ANN mapMaybeM_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'mapMaybeM_x1 `hasNoType` ''Stream.Step
inspect $ 'mapMaybeM_x1 `hasNoType` ''FL.Step
inspect $ 'mapMaybeM_x1 `hasNoType` ''SPEC
#endif

{-# ANN mapMaybeM_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'mapMaybeM_x4 `hasNoType` ''Stream.Step
...
{-# ANN intersperse_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'intersperse_x1 `hasNoType` ''Stream.Step
inspect $ 'intersperse_x1 `hasNoType` ''Stream.LoopState
inspect $ 'intersperse_x1 `hasNoType` ''FL.Step
inspect $ 'intersperse_x1 `hasNoType` ''SPEC
#endif

{-# ANN intersperse_x4 (PermitPatternMatches
    [''Int,''Stream.LoopState,''SPEC]) #-}
...
inspect $ 'intersperse_x4 `hasNoType` ''Stream.Step
-- inspect $ 'intersperse_x4 `hasNoType` ''Stream.LoopState
...
{-# ANN intersperseM_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'intersperseM_x1 `hasNoType` ''Stream.Step
inspect $ 'intersperseM_x1 `hasNoType` ''Stream.LoopState
...
{-# ANN insertBy_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'insertBy_x1 `hasNoType` ''Stream.Step
...
inspect $ 'insertBy_x4 `hasNoType` ''Stream.Step
...
{-# ANN unfoldEachSepBy_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'unfoldEachSepBy_x1 `hasNoType` ''Stream.Step
...
{-# ANN unfoldEachSepBySeq_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'unfoldEachSepBySeq_x1 `hasNoType` ''Stream.Step
inspect $ 'unfoldEachSepBySeq_x1 `hasNoType` ''Stream.LoopState
...
{-# ANN indexed_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'indexed_x1 `hasNoType` ''Stream.Step
inspect $ 'indexed_x1 `hasNoType` ''FL.Step
inspect $ 'indexed_x1 `hasNoType` ''SPEC
#endif

{-# ANN indexed_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'indexed_x4 `hasNoType` ''Stream.Step
...
{-# ANN indexedR_x1 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'indexedR_x1 `hasNoType` ''Stream.Step
inspect $ 'indexedR_x1 `hasNoType` ''FL.Step
inspect $ 'indexedR_x1 `hasNoType` ''SPEC
#endif

{-# ANN indexedR_x4 (PermitPatternMatches [''Int]) #-}
...
inspect $ 'indexedR_x4 `hasNoType` ''Stream.Step
...
{-# ANN reverseUnbox (PermitPatternMatches
    [''Int,''Array,''MutArray.GroupState,''MutByteArray,''SVar.State
    ,''Stream.Step]) #-}
{-# ANN reverseUnbox (PermitConstructions
    [''Array,''Maybe,''SVar.State,''MutArray.GroupState,''Int
    ,''MutByteArray,''Stream.Step,''(),''Bool]) #-}
...
-- inspect $ 'reverseUnbox `hasNoType` ''Stream.Step
#endif
