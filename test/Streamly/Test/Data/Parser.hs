...
mainCommon ptt = do
  describe (show ptt) $ do
    ...
    describe "test for sequence parser" $ do
        ...
        prop "P.take = Prelude.take" $ runParserTC_temp ptt Main.take
        ...
        prop "P.takeEQ = Prelude.take when len >= n and fail otherwise"
            $ runParserTC_temp ptt Main.takeEQ
        prop "P.takeGE n ls = ls when len >= n" $ runParserTC_temp ptt takeGEPass
        prop "P.takeGE n ls = ls when len >= n and fail otherwise" $ runParserTC_temp ptt Main.takeGE
