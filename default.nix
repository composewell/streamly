...
# TODO: specify additional haskell packages as arg options, include those
# packages and their deps as deps.
# TODO: specify additional source packages (e.g. streamly-benchmarks) as arg
# options
{
  nixpkgs ?
