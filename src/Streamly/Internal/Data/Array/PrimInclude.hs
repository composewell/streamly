...
toStream = Stream.fromStreamK . D.toStreamK . A.toStreamD
...
toStreamRev = Stream.fromStreamK . D.toStreamK . A.toStreamDRev
-- XXX add fallback to StreamK rule
...
fold f arr = P.fold f (Stream.toStreamK (toStream arr))
...
concat m =
    Stream.fromStreamK $ D.toStreamK $ D.unfoldMany read (D.fromStreamK $ Stream.toStreamK m)
...
compact n m =
    Stream.fromStreamK $ D.toStreamK $ A.packArraysChunksOf n (D.fromStreamK $ Stream.toStreamK m)
