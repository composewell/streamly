...
{-# INLINE _scanToChannel #-}
_scanToChannel :: MonadIO m => Channel m a b -> Scanl m a b -> Scanl m a ()
_scanToChannel chan (Scanl step initial extract final) =
...
scanToChannelRaw chan (Scanl step initial extract final) =
    Scanl step1 initial1 extract1 final1
