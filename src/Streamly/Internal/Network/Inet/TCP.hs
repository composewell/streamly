...
connectionsOnPort :: MonadAsync m => PortNumber -> Serial.Stream m Socket
connectionsOnPort = connectionsOnAddr (0,0,0,0)
...
connectionsOnLocalHost :: MonadAsync m => PortNumber -> Serial.Stream m Socket
connectionsOnLocalHost = connectionsOnAddr (127,0,0,1)
...
putBytes :: (MonadCatch m, MonadAsync m)
    => (Word8, Word8, Word8, Word8) -> PortNumber -> Serial.Stream m Word8 -> m ()
