...
-- similar to "Streamly.Data.Array.Unboxed" read write APIs. In that regard, arrays can
...
import Streamly.Internal.Data.Array.Unboxed.Mut.Type (fromForeignPtrUnsafe)
