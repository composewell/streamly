...
-- 'Streamly.Memory.Mutable.Array.writeF' fold and then wraps the lines in square
...
-- $arrays
--
-- Streamly arrays (See "Streamly.Memory.Mutable.Array") complement streams to provide an
